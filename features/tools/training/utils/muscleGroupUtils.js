...
const RULES = [
  ...
  ['Rücken', ['chin up', 'klimmzug', 'pull up', 'pull-up', 'latzug', 'lat pulldown', 'latmaschine', 'rudern', 'row', 'überzug', 'ueberzug', 'pullover', 'kreuzheben', 'deadlift', 'rückenstrecker', 'rueckenstrecker', 'back extension']],
  ['Schulter', ['schulterdrücken', 'schulterdruecken', 'shoulder press', 'arnold press', 'seitheben', 'lateral raise', 'frontheben', 'front raise', 'reverse butterfly', 'reverse pec deck', 'reverse fly', 'face pull', 'aufrechtes rudern', 'upright row']],
  ['Bizeps', ['bizeps', 'biceps', 'scottcurl', 'preacher curl', 'hammer curl', 'hammercurl', 'arnold curl', 'schrägbankcurl', 'schraegbankcurl', 'incline curl', 'kabelcurl', 'cable curl']],
